...
- **Favorite Notes**: Star/unstar individual notes; toggle "Favorites first" sorting in the notes panel
...
3. **Key Data Structures**:
   ...
   Note: {
     id, text, timestamp, createdAt, autoGenerated, aiGenerated, favorite
   }
